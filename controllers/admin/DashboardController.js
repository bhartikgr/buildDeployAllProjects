      ...
      const order = await axios.post(
        `${PAYPAL_API}/v2/checkout/orders`,
        {
          ...
          application_context: {
            ...
            landing_page: "LOGIN",
            user_action: "PAY_NOW",
            return_url: `https://communitysponsor.org/backend/admindashboard/?hostId=${hostId}&proposalId=${proposalId}&amount=${amount}`,
            cancel_url: `https://communitysponsor.org/backend/admindashboard/?hostId=${hostId}&proposalId=${proposalId}&amount=${amount}`,
          },
        },
        {
          headers: {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
          ...
          <p style="color: #9ca3af; font-size: 12px; margin: 5px 0 0 0;">
            <a href="https://communitysponsor.org/backend" style="color: #3b82f6; text-decoration: none;">Visit our website</a> | 
